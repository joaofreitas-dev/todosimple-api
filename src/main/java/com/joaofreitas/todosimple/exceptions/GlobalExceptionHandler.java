package com.joaofreitas.todosimple.exceptions;
...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleObkectNotFoundException(
            ObjectNotFoundException objectNotFoundException,
            WebRequest request) {
        log.error("Faild to find the requested element", objectNotFoundException);
